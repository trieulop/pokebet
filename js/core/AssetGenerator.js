...
class AssetGenerator {
    ...
    static statIcons = {
        maxHp: `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="#e63946" style="vertical-align: middle; margin-right: 2px;"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg>`,
        hp: `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="#e63946" style="vertical-align: middle; margin-right: 2px;"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg>`,
        atk: `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="#ccc" style="vertical-align: middle; margin-right: 2px;"><path d="M14.68 13L16 11.68L18.68 14.35L20 13L17.32 10.32L18.68 8.96L14.68 5L9.36 10.32L13.33 14.28L14.68 13ZM7.36 12.32L9.36 10.32L10.68 11.68L8.68 13.68L7.36 12.32ZM3 21L4.41 22.41L12.32 14.5L10.91 13.09L3 21Z"/></svg>`,
        def: `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="#457b9d" style="vertical-align: middle; margin-right: 2px;"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4z"/></svg>`,
        spd: `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="#fca311" style="vertical-align: middle; margin-right: 2px;"><path d="M14 2H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h4l2 2 2-2h2c1.1 0 2-.9 2-2V8l-6-6zm-1 7V3.5L18.5 9H13z"/></svg>`
    };

    static getStatIcon(stat) {
